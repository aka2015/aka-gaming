...
const GAME_ID = "robot-builder";
const STORAGE_KEY = "rb_progress_v1";
const MUTE_KEY = "rb_muted_v1";
...
const LEVELS = [
  ...
  // ── 7-21: maze labirin (dinding & belokan) ──
  {
    id: 7, grid: { w: 3, h: 3 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 2, y: 2 },
    walls: [], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 4,
    goalText: "Temukan jalan melewati labirin!",
    hint: "Coba gerakan maju, belok, dan maju lagi."
  },
  {
    id: 8, grid: { w: 3, h: 3 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 2, y: 0 },
    walls: [], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 2,
    goalText: "Lurus dulu, baru cari jalan ke tujuan.",
    hint: "2 langkah maju sudah cukup."
  },
  {
    id: 9, grid: { w: 4, h: 4 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 3, y: 3 },
    walls: [{"x": 1, "y": 1}, {"x": 2, "y": 1}, {"x": 1, "y": 2}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 7,
    goalText: "Ada dinding di tengah! Cari jalan lain.",
    hint: "Lewat tepi kanan dulu, lalu belok ke bawah."
  },
  {
    id: 10, grid: { w: 4, h: 4 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 2, y: 2 },
    walls: [{"x": 1, "y": 1}, {"x": 2, "y": 1}, {"x": 0, "y": 3}, {"x": 1, "y": 3}, {"x": 3, "y": 3}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 9,
    goalText: "Labirin dengan banyak dinding.",
    hint: "Ikuti tepi kiri atau kanan sampai menemukan jalannya."
  },
  {
    id: 11, grid: { w: 5, h: 4 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 4, y: 3 },
    walls: [{"x": 3, "y": 0}, {"x": 1, "y": 1}, {"x": 3, "y": 2}, {"x": 0, "y": 3}, {"x": 1, "y": 3}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 11,
    goalText: "Labirin panjang, butuh banyak langkah!",
    hint: "Majulah langkah demi langkah, belok saat ada dinding."
  },
  {
    id: 12, grid: { w: 4, h: 4 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 3, y: 3 },
    walls: [{"x": 1, "y": 1}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 7,
    goalText: "Hanya satu dinding. Cari jalan memutar!",
    hint: "Jangan lewat tengah, lewati tepi saja."
  },
  {
    id: 13, grid: { w: 5, h: 5 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 4, y: 4 },
    walls: [{"x": 1, "y": 1}, {"x": 2, "y": 1}, {"x": 3, "y": 1}, {"x": 1, "y": 3}, {"x": 2, "y": 3}, {"x": 3, "y": 3}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 10,
    goalText: "Dua blok dinding di kiri dan kanan.",
    hint: "Pinggir jalan selalu aman, ikuti saja."
  },
  {
    id: 14, grid: { w: 5, h: 5 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 2, y: 2 },
    walls: [{"x": 1, "y": 1}, {"x": 3, "y": 1}, {"x": 1, "y": 3}, {"x": 3, "y": 3}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 6,
    goalText: "Pola dinding kotak-kotak.",
    hint: "Cari celah di antara dinding untuk sampai ke tengah."
  },
  {
    id: 15, grid: { w: 5, h: 5 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 4, y: 4 },
    walls: [{"x": 1, "y": 0}, {"x": 3, "y": 1}, {"x": 0, "y": 2}, {"x": 1, "y": 2}, {"x": 3, "y": 3}, {"x": 1, "y": 4}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 15,
    goalText: "Labirin rapat! Butuh konsentrasi.",
    hint: "Coba gambar jalannya di kertas dulu."
  },
  {
    id: 16, grid: { w: 6, h: 6 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 5, y: 5 },
    walls: [{"x": 1, "y": 1}, {"x": 2, "y": 1}, {"x": 3, "y": 1}, {"x": 3, "y": 3}, {"x": 4, "y": 3}, {"x": 1, "y": 4}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 13,
    goalText: "Labirin besar 6x6 dengan dinding.",
    hint: "Pake strategi: ikuti salah satu tepi sampai sampai tujuan."
  },
  {
    id: 17, grid: { w: 5, h: 5 }, start: { x: 2, y: 2, dir: 1 }, goal: { x: 0, y: 0 },
    walls: [{"x": 1, "y": 1}, {"x": 3, "y": 1}, {"x": 1, "y": 3}, {"x": 3, "y": 3}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 6,
    goalText: "Mulai dari tengah!",
    hint: "Cari jalan ke pojok kiri atas."
  },
  {
    id: 18, grid: { w: 5, h: 5 }, start: { x: 4, y: 4, dir: 1 }, goal: { x: 0, y: 0 },
    walls: [{"x": 3, "y": 0}, {"x": 1, "y": 1}, {"x": 3, "y": 2}, {"x": 0, "y": 3}, {"x": 3, "y": 4}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 13,
    goalText: "Dari pojok kanan bawah ke kiri atas!",
    hint: "Lebih panjang jalannya, hati-hati salah belok."
  },
  {
    id: 19, grid: { w: 6, h: 6 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 5, y: 5 },
    walls: [{"x": 1, "y": 1}, {"x": 3, "y": 1}, {"x": 4, "y": 1}, {"x": 1, "y": 3}, {"x": 2, "y": 3}, {"x": 4, "y": 3}, {"x": 1, "y": 5}, {"x": 3, "y": 5}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 15,
    goalText: "Dinding berlapis - labirin kompleks!",
    hint: "Butuh 15+ langkah. Sabar ya!"
  },
  {
    id: 20, grid: { w: 6, h: 6 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 5, y: 5 },
    walls: [{"x": 3, "y": 0}, {"x": 1, "y": 1}, {"x": 5, "y": 1}, {"x": 3, "y": 2}, {"x": 0, "y": 3}, {"x": 5, "y": 3}, {"x": 2, "y": 4}, {"x": 4, "y": 5}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 17,
    goalText: "Jalannya berliku!",
    hint: "Setiap ada dinding, belok dan cari jalan baru."
  },
  {
    id: 21, grid: { w: 7, h: 7 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 6, y: 6 },
    walls: [{"x": 1, "y": 1}, {"x": 2, "y": 1}, {"x": 4, "y": 1}, {"x": 5, "y": 1}, {"x": 1, "y": 3}, {"x": 3, "y": 3}, {"x": 5, "y": 3}, {"x": 1, "y": 5}, {"x": 2, "y": 5}, {"x": 4, "y": 5}, {"x": 5, "y": 5}], holes: [], stars: [],
    blocks: ["move", "turnRight", "turnLeft"], optimal: 16,
    goalText: "🏆 BOSS maze! Labirin 7x7 terbesar!",
    hint: "Gunakan semua skill yang sudah dipelajari!"
  },

  // ── 22-24: single loop ──
  {
    id: 22, grid: { w: 7, h: 1 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 6, y: 0 },
  ...
  {
    id: 23, grid: { w: 4, h: 4 }, start: { x: 0, y: 3, dir: 0 }, goal: { x: 3, y: 0 },
  ...
  {
    id: 24, grid: { w: 5, h: 5 }, start: { x: 0, y: 4, dir: 0 }, goal: { x: 4, y: 0 },
  ...
  // ── 25-27: combined sequencing + single loop ──
  {
    id: 25, grid: { w: 5, h: 3 }, start: { x: 0, y: 2, dir: 1 }, goal: { x: 4, y: 0 },
  ...
  {
    id: 26, grid: { w: 5, h: 5 }, start: { x: 0, y: 4, dir: 1 }, goal: { x: 4, y: 0 },
  ...
  {
    id: 27, grid: { w: 6, h: 4 }, start: { x: 0, y: 3, dir: 1 }, goal: { x: 5, y: 0 },
  ...
  // ── 28-31: nested loops ──
  {
    id: 28, grid: { w: 6, h: 1 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 5, y: 0 },
  ...
  {
    id: 29, grid: { w: 5, h: 5 }, start: { x: 0, y: 4, dir: 0 }, goal: { x: 4, y: 0 },
  ...
  {
    id: 30, grid: { w: 6, h: 3 }, start: { x: 0, y: 1, dir: 1 }, goal: { x: 5, y: 1 },
  ...
  {
    id: 31, grid: { w: 4, h: 4 }, start: { x: 0, y: 0, dir: 2 }, goal: { x: 3, y: 3 },
  ...
  // ── 32-35: conditional + advanced ──
  {
    id: 32, grid: { w: 6, h: 1 }, start: { x: 0, y: 0, dir: 1 }, goal: { x: 5, y: 0 },
  ...
  {
    id: 33, grid: { w: 5, h: 3 }, start: { x: 0, y: 1, dir: 1 }, goal: { x: 4, y: 1 },
  ...
  {
    id: 34, grid: { w: 7, h: 3 }, start: { x: 0, y: 2, dir: 1 }, goal: { x: 6, y: 2 },
  ...
  {
    id: 35, grid: { w: 6, h: 5 }, start: { x: 0, y: 4, dir: 0 }, goal: { x: 5, y: 0 },
