#!/bin/bash
# =====================================================
# Tower Defense Pro - Full Deployment Script
# Run this on the VPS: bash deploy-tdp-full.sh
# =====================================================

set -e

echo " Deploying Tower Defense Pro to AKA Gaming..."
echo ""
...
echo "✅ Game files created at /var/www/games/tower-defense-pro/"
echo ""
echo "📋 Next step: Add to Firestore"
echo "Run this command:"
echo ""
echo "cd /opt/aka-gaming && node -e \""
echo "const admin = require('firebase-admin');"
echo "admin.initializeApp({ credential: admin.credential.cert(require('./service-account.json')) });"
echo "admin.firestore().collection('games').doc('tower-defense-pro').set({"
echo "  title: 'Tower Defense Pro',"
echo "  description: 'Defend your base with 4 unique towers!',"
echo "  authorId: 'hasanzuke@gmail.com',"
echo "  authorName: 'AKA Gaming',"
echo "  status: 'published',"
echo "  category: 'strategy',"
echo "  emoji: '🗼',"
echo "  likes: 0, plays: 0,"
echo "  createdAt: Date.now(),"
echo "  publishedAt: Date.now()"
echo "}).then(() => console.log('✅ Added to Firestore!'));"
echo "\""
echo ""
echo "Then restart PM2: pm2 restart aka-gaming"
